...
// >=== #123455
public class CircleLayoutManager extends RecyclerView.LayoutManager implements RecyclerView.SmoothScroller.ScrollVectorProvider {
    ...
    public CircleLayoutManager(int orientation) {
    ...
    /**
     * Layout the item view witch position specified by {@link CircleLayoutManager#mInitialSelectedPosition} first and then layout the other
     *
     * @param recycler
     * @param state
     */
    ...
    /**
     * Layout the item view witch position special by {@link CircleLayoutManager#mInitialSelectedPosition} first and then layout the other
     *
     * @param recycler
     * @param state
     */
    ...
    private float calculateToCenterFraction(View child, float pendingOffset) {
        ...
        int childLength = mOrientation == CircleLayoutManager.HORIZONTAL ? child.getWidth() : child.getHeight();
    ...
    private int calculateDistanceCenter(View child, float pendingOffset) {
        ...
        if (mOrientation == CircleLayoutManager.HORIZONTAL) {
    ...
    private void fillWithVertical(RecyclerView.Recycler recycler, RecyclerView.State state, int dy) {
        ...
        if (dy >= 0) {
            ...
            if (getChildCount() > 0) {
                ...
                startPosition = getPosition(firstView) - 1;
     ...
     */
    public void attach(final RecyclerView recyclerView, int selectedPosition) {
    ...
    public interface ItemTransformer {
         ...
         */
        void transformItem(CircleLayoutManager layoutManager, View item, float fraction);
    }
