...
/**
 * Created by dattien on 10/28/17.
 */
 ...
 * the measure pass.
 */
public class Layoutmanagercustom extends android.support.v7.widget.LinearLayoutManager {
    ...
    @SuppressWarnings("UnusedDeclaration")
    public Layoutmanagercustom(RecyclerView view) {
    ...
    @SuppressWarnings("UnusedDeclaration")
    public Layoutmanagercustom(RecyclerView view, int orientation, boolean reverseLayout) {
